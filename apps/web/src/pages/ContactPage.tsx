...
const channels = [
  ...
  { icon: ExternalLink, label: "LinkedIn", value: "Professional profile", href: profile.linkedin },
  ...
  return (
    <PageTransition>
      <PageIntro
        index="05"
        eyebrow="Contact"
        title="Let’s build something useful, measurable, and trusted."
        description="Open to analytics engineering, data applications, internal platforms, automation, business intelligence, solutions engineering, and full-stack roles where operational context matters."
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16">
          <Reveal>
            ...
            <div className="mt-8 border-l border-white/[0.08] p-6">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-500">Best conversations include the business problem, the users affected, the data available, and what a successful outcome should change.</p>
            </div>
          </Reveal>
